...
- **Priorytet:** (np. Blocker, Critical, Major, Minor, Trivial) - określa wpływ błędu na działanie aplikacji i pilność naprawy.
  - _Blocker:_ Uniemożliwia dalsze testowanie kluczowych funkcjonalności.
  - _Critical:_ Poważny błąd w kluczowej funkcjonalności, brak obejścia.
  - _Major:_ Poważny błąd, ale istnieje obejście lub dotyczy mniej krytycznej funkcjonalności.
  - _Minor:_ Drobny błąd, niewielki wpływ na UX lub funkcjonalność.
  - _Trivial:_ Błąd kosmetyczny, literówka.
