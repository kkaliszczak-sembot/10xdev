          ...
          <CardFooter class="flex justify-between text-sm text-muted-foreground border-t pt-4 bg-muted/10">
            ...
            <div class="flex space-x-2">
              ...
              <Button 
                ...
                variant="default"
              >
                <svg v-if="isSaving" class="animate-spin -ml-1 mr-2 h-4 w-4 text-primary-foreground" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <div class="space-y-6">
              ...
              >
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      v-model="formValues.main_problem"
              ...
              <!-- Minimal feature set -->
              <FormField
                name="min_feature_set"
              >
                <FormItem>
                  <FormLabel>Minimal Feature Set</FormLabel>
                  <FormControl>
                    <Textarea
                      v-model="formValues.min_feature_set"
                      placeholder="What are the essential features needed for this project?"
                      class="min-h-[120px]"
                    />
                  </FormControl>
                  <FormMessage />
              ...
              >
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      v-model="formValues.out_of_scope"
              ...
              >
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      v-model="formValues.success_criteria"
